...
wid <- read_excel("Data/WIID_19Dec2018.xlsx")
...
# Interludium: from data to figures
 ...
 * You can use [this tool](https://davidmathlogic.com/colorblind/) to
   design colorblind friendly palettes
